...
public class Card extends JLabel implements MouseListener
{
	...
	public boolean pairSuit(Card card){
	...
	public boolean pairRank(Card card){
	...
	public boolean trioSameSuit(Card card1, Card card2){
		if(card1.getSuit().equals(card2.getSuit()) && this.suit.equals(card1.getSuit())
				&& this.suit.equals(card2.getSuit())){
			return true;
		}
		else return false;
	}

	public boolean trioSameRank(Card card1, Card card2){
		if(card1.getRank().equals(card2.getRank()) && this.rank.equals(card1.getRank())
				&& this.rank.equals(card2.getRank())){
			return true;
		}
		else return false;
	}	
