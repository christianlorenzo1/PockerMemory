...
public class MemoryGame implements ActionListener {
	...
	public MemoryGame () throws IOException
	{
		...
		newMenuItem("TPandTW Level", difficultyMenu, this);
		newMenuItem("SteelWheel Level", difficultyMenu, this);
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		try {
			...
			else if(e.getActionCommand().equals("TPandTW Level")) newGame("two");
			else if(e.getActionCommand().equals("SteelWheel Level")) newGame("steel");
	...
	public void newGame(String difficultyMode) throws IOException
	{
		...
		else if(difficultyMode.equalsIgnoreCase("two")){
			this.difficulty = new TwoPairsandThirdWheel(this.turnCounterLabel, this.mainFrame);
		}
		else if(difficultyMode.equalsIgnoreCase("steel")){
			this.difficulty = new SteelWheel(this.turnCounterLabel, this.mainFrame);
		}
